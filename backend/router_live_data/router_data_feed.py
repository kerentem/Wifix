...
def limit_upload_download_speed(upload_speed, download_speed):
    ...
    egress_bandwidth_field = driver.find_element(
        By.XPATH,
    ...
    egress_bandwidth_field = driver.find_element(
        By.XPATH,
        "/html/body/form/center/table/tbody/tr[3]/td/table/tbody/tr[4]/td[" "2]/input",
    )
    egress_bandwidth_field.clear()
...
def get_wireless_customer_data() -> dict:
    ...
    driver.switch_to.default_content()
    driver.switch_to.frame("mainFrame")
    amount_connected_devices = driver.find_element(
    ...
    for connection in amount_range:
        ...
        connection_recieved_packets = driver.find_element(
            By.XPATH,
